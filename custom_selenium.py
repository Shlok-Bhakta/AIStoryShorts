...
import json
import time
from custom_selenium_const import *
...
class YouTubeUploader:
    ...
    def __upload(self) -> (bool, Optional[str]):
        ...
        if video_description:
            ...
            description_field = self.browser.find(By.CSS_SELECTOR, Constant.DESCTEXTBOX)
        ...
        self.browser.find(By.ID, Constant.NEXT_BUTTON).click()
        self.logger.debug('Clicked a third {}'.format(Constant.NEXT_BUTTON))
        ...
        # Schedule Button
        self.browser.find(By.CSS_SELECTOR, Constant.SCHEDULE_BUTTON).click()
        
        schedule_field = self.browser.find(By.CSS_SELECTOR, Constant.SCHEDTEXTBOX)
        time.sleep(Constant.USER_WAITING_TIME)
        schedule_field.click()
        time.sleep(Constant.USER_WAITING_TIME)
        schedule_field.clear()
        time.sleep(Constant.USER_WAITING_TIME)
        schedule_field.send_keys(self.metadata_dict[Constant.SCHEDULE], Keys.ENTER)
        time.sleep(Constant.USER_WAITING_TIME)
